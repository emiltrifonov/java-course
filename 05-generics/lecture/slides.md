...
- би било много по-удобно
    - програмистът да може да изрази намерението си да ползва определен тип и
...
- Казваме, че параметризираният тип (в случая - `Integer`) е *инвариантен*, т.е. не може да присвоим на негово място `Number`
